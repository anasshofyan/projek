...
<section>
	<div class="carousel-item active bg-info">
		<img class="d-block w-100 " src="./asset/img/21.jpg" style="opacity: 0.7">
		<div class="carousel-caption d-none d-md-block">
			<div style="margin-bottom: 13%;">
				<h1 style="color: #FFFFFF">Design</h1>
...
<div class="container mt-5">
	<div class="row">
		<?php $result = mysqli_query($conn, "SELECT * FROM tabel_produk, table_kategori WHERE  tabel_produk.id_kategori=table_kategori.id_kategori AND  tabel_produk.id_kategori=2 ") ?> 
