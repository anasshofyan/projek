...
<section>
	<div class="carousel-item active">
		<img class="d-block w-100 " src="./asset/img/13.jpg">
		<div class="carousel-caption d-none d-md-block">
			<div style="margin-bottom: 13%;">
				<h1 style="color: #3A3A3A;">Intermediate</h1>
...
<div class="container mt-5">
	<div class="row">
		<?php $result = mysqli_query($conn, "SELECT * FROM tabel_produk WHERE level_produk='intermediate'") ?> 
